...
/** -------------------------------------------------------------------
 * Find and return the starting vertices for the graph
 * @param graph the graph
 ...
 * Find and return the starting vertices for the graph
 * @param graph the graph
 * @return ending vertex index
 */
int findEndVertex(Graph *graph);

/** -------------------------------------------------------------------
 * Check to see if there is a path between vertices of for cut player
 * @param graph the graph
 * @param start staring vertex index
 * @param end ending vertex index
 * @param depth used to keep track of recursion depth, call function initially set to 0
 * @return 0 if there is a route, 1 if there is not
 */
int checkPathCut(Graph *graph, int start, int end, int depth);


/** -------------------------------------------------------------------
 * Check to see if there is a path between vertices of for short player
 * @param graph the graph
 * @param start staring vertex index
 * @param end ending vertex index
 * @param depth used to keep track of recursion depth, call function initially set to 0
 * @return 1 if there is a route, 0 if there is not
 */
