 ...
 *          The types of errors include compile, runtime, and logic.
 * ===========================================================
 */
 ...
 * @param argHigh high index into arrays
 * @return pivot index
 * @pre argLow and argHigh are values in range of array index, argHigh >= argLow; argWordCount is 
 * an array of WordCount
